...
"use strict";module.exports=function(){for(var l=document.getElementsByClassName("collapsible"),e=document.getElementsByClassName("collapsible-dropdown"),s=function(s){l[s].addEventListener("click",function(){this.classList.toggle("active"),this.classList.toggle("collapse-margin");var l=this.nextElementSibling;e[s].classList.toggle("collapsible-dropdown-close"),"block"===l.style.display?l.style.display="none":l.style.display="block"})},t=0;t<l.length;t++)s(t)};

},{}],26:[function(require,module,exports){
"use strict";function init(){this.$=require("jquery/dist/jquery"),this.jQuery=this.$,require("svg4everybody/dist/svg4everybody")(),$(document).ready(function(){require("ddslick/dist/jquery.ddslick.min"),require("./components/collapse")()})}require("core-js/modules/es6.function.bind"),init.bind(window)();

},{"./components/collapse":25,"core-js/modules/es6.function.bind":21,"ddslick/dist/jquery.ddslick.min":22,"jquery/dist/jquery":23,"svg4everybody/dist/svg4everybody":24}]},{},[26]);
