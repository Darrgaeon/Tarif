...
"use strict";module.exports=function(){$(document).ready(function(){$(".gallery-slides").slick({dots:!0,dotsClass:"slick-dots",slidesToShow:1,slidesToScroll:1,arrows:!1})})};
...
"use strict";module.exports=function(){var i=$(".sub-menu");$("nav ul li a:not(:only-child)").click(function(n){$(this).siblings(i).toggle(),i.not($(this).siblings()).hide(),n.stopPropagation()})};

},{}],29:[function(require,module,exports){
"use strict";function init(){this.$=require("jquery/dist/jquery"),this.jQuery=this.$,require("svg4everybody/dist/svg4everybody")(),$(document).ready(function(){require("slick-carousel/slick/slick.min"),require("./components/collapse")(),require("./components/items-category")(),require("./components/carousel")(),require("./components/sub-menu")()})}require("core-js/modules/es6.function.bind"),init.bind(window)();

},{"./components/carousel":25,"./components/collapse":26,"./components/items-category":27,"./components/sub-menu":28,"core-js/modules/es6.function.bind":21,"jquery/dist/jquery":22,"slick-carousel/slick/slick.min":23,"svg4everybody/dist/svg4everybody":24}]},{},[29]);
