...
"use strict";require("core-js/modules/es6.array.find"),module.exports=function(){if($(".content-description-contacts").length){var e=$(".content-description-contacts form");e.find("input[name='phone']").mask("05 99999999"),e.validate({errorPlacement:function(e,n){},rules:{phone:{required:!0,phoneCheck:!0,minlength:7},name:{required:!0,minlength:4,textCheck:!0},email:{required:!0,email:!0,minlength:2},comment:{required:!0,minlength:4,textCheck:!0},message:{required:!0}}})}};

},{"core-js/modules/es6.array.find":35}],46:[function(require,module,exports){
...
"use strict";module.exports=function(){var t=$(".mobile-menu"),n=$(".nav-bar-button-open"),o=$(".nav-bar-button-close");n.on("click",function(){t.css("left","0")}),o.on("click",function(){t.css("left","-250px")}),$(function(n){n(document).mouseup(function(n){t.is(n.target)||0!==t.has(n.target).length||t.css("left","-250px")})})};
