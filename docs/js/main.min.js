...
"use strict";module.exports=function(){$("#demoBasic").ddslick({data:[{text:"Rus",value:1,selected:!0,image:"../../../../svg/rectangle 2.svg"},{text:"Eng",value:2,selected:!1,imageSrc:"http://i.imgur.com/8ScLNnk.png"}],width:300,imagePosition:"left",selectText:"Select your favorite social network",onSelected:function(e){console.log(e)}})};

},{}],26:[function(require,module,exports){
"use strict";function init(){this.$=require("jquery/dist/jquery"),this.jQuery=this.$,require("svg4everybody/dist/svg4everybody")(),$(document).ready(function(){require("ddslick/dist/jquery.ddslick.min"),require("./components/select")()})}require("core-js/modules/es6.function.bind"),init.bind(window)();

},{"./components/select":25,"core-js/modules/es6.function.bind":21,"ddslick/dist/jquery.ddslick.min":22,"jquery/dist/jquery":23,"svg4everybody/dist/svg4everybody":24}]},{},[26]);
