...
},{"jquery":23}],25:[function(require,module,exports){
...
"use strict";module.exports=function(){$(".call-back").length&&$(".call-back__me form").validate({rules:{phone:{required:!0,phoneCheck:!0,minlength:7},name:{required:!0,minlength:4,nameCheck:!0},email:{required:!0,email:!0,minlength:2},message:{required:!0}}})};
...
"use strict";require("core-js/modules/es6.function.bind"),module.exports=function(){if($(".content-description-contacts").length){var e=$(".content-description-contacts form"),t=$(".content-description-contacts form textarea"),n=$(".comment-error");e.validate({rules:{phone:{required:!0,phoneCheck:!0,minlength:7},name:{required:!0,minlength:4,nameCheck:!0},email:{required:!0,email:!0,minlength:2},message:{required:!0}}}),t.bind("input property change",function(e){e.preventDefault(),e.target.textLength>2?t.addClass("textarea-valid"):t.removeClass("textarea-valid"),t.hasClass("textarea-valid")?n.css("display","block"):n.css("display","none")})}};

},{"core-js/modules/es6.function.bind":21}],30:[function(require,module,exports){
"use strict";module.exports=function(){$.validator.addMethod("phoneCheck",function(t,e){return!/_/.test(t)}),$.validator.addMethod("nameCheck",function(t,e){return t.length>2&&!/[0-9_!?.+\-]+/.test(t)})};
...
"use strict";module.exports=function(){var n=$(".mobile-menu"),o=$(".nav-bar-button-open"),t=$(".nav-bar-button-close");o.on("click",function(){n.css("width","250px")}),t.on("click",function(){n.css("width","0")})};

},{}],33:[function(require,module,exports){
"use strict";module.exports=function(){var e=$(".nav-bar .nav-bar-menu");e.length&&e.on("click","ul > li",function(){var e=$(this).children(".sub-menu");e.fadeToggle(200),e.mouseleave(function(){$(this).stop().slideUp()})})};

},{}],34:[function(require,module,exports){
"use strict";module.exports=function(){var a=$(".nav-bar__switch-language"),n=$(".switch-language__sub-menu");a.on("click",function(){n.fadeToggle(200)}),n.on("click","li",function(){var a=$(this).data("short-name");$(".nav-bar__switch-language span").text(a)}),n.mouseleave(function(){$(this).stop().slideUp()})};

},{}],35:[function(require,module,exports){
"use strict";function init(){this.$=require("jquery/dist/jquery"),this.jQuery=this.$,require("svg4everybody/dist/svg4everybody")(),$(document).ready(function(){require("slick-carousel/slick/slick.min"),require("jquery-validation/dist/jquery.validate"),require("./components/collapse")(),require("./components/carousel")(),require("./components/sub-menu")(),require("./components/switch-language")(),require("./components/items-providers")(),require("./components/mobile-menu")(),require("./components/forms-validate")(),require("./components/call-back-form")(),require("./components/contacts-form")()})}require("core-js/modules/es6.function.bind"),init.bind(window)();

},{"./components/call-back-form":26,"./components/carousel":27,"./components/collapse":28,"./components/contacts-form":29,"./components/forms-validate":30,"./components/items-providers":31,"./components/mobile-menu":32,"./components/sub-menu":33,"./components/switch-language":34,"core-js/modules/es6.function.bind":21,"jquery-validation/dist/jquery.validate":22,"jquery/dist/jquery":23,"slick-carousel/slick/slick.min":24,"svg4everybody/dist/svg4everybody":25}]},{},[35]);
