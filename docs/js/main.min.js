...
var core=module.exports={version:"2.6.0"};"number"==typeof __e&&(__e=core);
...
!function(e){"function"==typeof define&&define.amd?define(["jquery"],e):"object"==typeof module&&module.exports?module.exports=e(require("jquery")):e(window.jQuery)}(function(e){function d(e,d){var i=e.find(".dd-option-value[value= '"+d+"']").parents("li").prevAll().length;t(e,i)}function t(d,t,i){var a=d.data("ddslick"),o=d.find(".dd-selected"),s=d.find(".dd-options"),l=o.siblings(".dd-selected-value"),r=d.find(".dd-option").eq(t),c=a.settings,p=a.settings.data[t];if(d.find(".dd-option").removeClass("dd-option-selected"),r.addClass("dd-option-selected"),s.attr("aria-activedescendant",r.attr("id")),a.selectedIndex=t,a.selectedItem=r,a.selectedData=p,c.showSelectedHTML){var f=e("<div>");p.imageSrc&&f.append(e("<img>").addClass("dd-selected-image"+("right"===c.imagePosition?" dd-image-right":"")).attr("src",p.imageSrc)),p.text&&f.append(e("<label>").addClass("dd-selected-text").text(p.text)),p.description&&f.append(e("<small>").addClass("dd-selected-description dd-desc"+(c.truncateDescription?" dd-selected-description-truncated":"")).text(p.description)),o.html(f.html())}else o.html(p.text);l.val(p.value),a.original.val(p.value),d.data("ddslick",a),n(d),d.find(".dd-selected").focus(),function(e){var d=e.find(".dd-select").css("height"),t=e.find(".dd-selected-description"),i=e.find(".dd-selected-image");t.length<=0&&i.length>0&&e.find(".dd-selected-text").css("lineHeight",d)}(d),i&&"function"==typeof c.onSelected&&c.onSelected.call(this,a)}function i(d){var t=d.find(".dd-select"),i=d.find(".dd-selected"),n=t.siblings(".dd-options"),a=t.find(".dd-pointer"),s=n.is(":visible"),l=o[d.attr("data-settings-id")];e(".dd-click-off-close").not(n).slideUp(l.animationTime),e(".dd-pointer").removeClass("dd-pointer-up"),t.removeClass("dd-open"),i.attr("aria-expanded","false"),n.attr("aria-hidden","true"),s?(n.slideUp(l.animationTime),a.removeClass("dd-pointer-up"),t.removeClass("dd-open"),i.attr("aria-expanded","false"),n.attr("aria-hidden","true")):(t.addClass("dd-open"),n.slideDown(l.animationTime),a.addClass("dd-pointer-up"),i.attr("aria-expanded","true"),n.attr("aria-hidden","false").focus()),function(d){d.find(".dd-option").each(function(){var t=e(this),i=t.css("height"),n=t.find(".dd-option-description"),a=d.find(".dd-option-image");n.length<=0&&a.length>0&&t.find(".dd-option-text").css("lineHeight",i)})}(d)}function n(e){var d=o[e.attr("data-settings-id")];e.find(".dd-select").removeClass("dd-open"),e.find(".dd-selected").attr("aria-expanded","false"),e.find(".dd-options").slideUp(d.animationTime).attr("aria-hidden","true"),e.find(".dd-pointer").removeClass("dd-pointer-up").removeClass("dd-pointer-up")}e.fn.ddslick=function(d){return a[d]?a[d].apply(this,Array.prototype.slice.call(arguments,1)):"object"!=typeof d&&d?void e.error("Method "+d+" does not exists."):a.init.apply(this,arguments)};var a={},o={},s={data:[],keepJSONItemsOnTop:!1,animationTime:50,width:260,height:null,background:"#eee",selectText:"",defaultSelectedIndex:null,truncateDescription:!0,imagePosition:"left",showSelectedHTML:!0,clickOffToClose:!0,embedCSS:!0,onSelected:function(){}},l=!1;a.init=function(d){var a=e.extend({},s,d);return e("#css-ddslick").length<=0&&a.embedCSS&&e("<style id='css-ddslick' type='text/css'>.dd-select{ border-radius:2px; border:solid 1px #ccc; position:relative; cursor:pointer;}.dd-desc { color:#aaa; display:block; overflow: hidden; font-weight:normal; line-height: 1.4em; }.dd-selected{ position:relative; overflow:hidden; display:block; padding:10px; font-weight:bold; width:100%; text-align:left;}.dd-selected:focus { z-index:2001; }.dd-pointer{ width:0; height:0; position:absolute; right:10px; top:50%; margin-top:-3px;}.dd-selected:focus + .dd-pointer{ z-index:2002; }.dd-pointer-down{ border:solid 5px transparent; border-top:solid 5px #000; }.dd-pointer-up{border:solid 5px transparent !important; border-bottom:solid 5px #000 !important; margin-top:-8px;}.dd-options{ border:solid 1px #ccc; border-top:none; list-style:none; box-shadow:0px 1px 5px #ddd; display:none; position:absolute; z-index:2000; margin:0; padding:0;background:#fff; overflow:visible;}.dd-options:focus{ outline:0; }.dd-option{ padding:10px; display:block; width:100%; text-align:left; border-bottom:solid 1px #ddd; overflow:visible; text-decoration:none; color:#333; cursor:pointer;-webkit-transition: all 0.25s ease-in-out; -moz-transition: all 0.25s ease-in-out;-o-transition: all 0.25s ease-in-out;-ms-transition: all 0.25s ease-in-out; box-sizing:border-box;}.dd-options > .dd-option:last-child { border-bottom:none;}.dd-option:hover, .dd-option:active, .dd-option:focus{ background:#f3f3f3; color:#000; z-index:2001;}.dd-selected-description-truncated { text-overflow: ellipsis; white-space:nowrap; }.dd-option-selected { background:#f6f6f6; }.dd-option-image, .dd-selected-image { vertical-align:middle; float:left; margin-right:5px; max-width:64px;}.dd-image-right { float:right; margin-right:15px; margin-left:5px;}.dd-container{ position:relative;}​ .dd-selected-text { font-weight:bold}​</style>").appendTo("head"),this.each(function(){var a=e.extend({},s,d),r=e(this);if(!r.data("ddslick")){var c=[];r.find("option").each(function(){var d=e(this),t=d.data();c.push({text:e.trim(d.text()),value:d.val(),selected:d.is(":selected"),description:t.description,imageSrc:t.imagesrc})}),a.keepJSONItemsOnTop?e.merge(a.data,c):a.data=e.merge(c,a.data);var p=r,f=e("<div>").attr("id",r.attr("id"));r.replaceWith(f),r=f;var u="ID_"+(new Date).getTime();e(r).attr("data-settings-id",u),o[u]={},e.extend(o[u],a),r.addClass("dd-container").append("<div class='dd-select'><input class='dd-selected-value' type='hidden' /><button type='button' class='dd-selected'></button><span class='dd-pointer dd-pointer-down'></span></div>").append("<ul class='dd-options'></ul>"),r.find("input.dd-selected-value").attr("id",e(p).attr("id")).attr("name",e(p).attr("name"));var h=r.find(".dd-options");c=r.find(".dd-select");var g=r.find(".dd-selected");g.attr("aria-haspopup","listbox"),g.attr("aria-expanded","false"),g.attr("aria-controls","dd-options-"+u),h.attr("id","dd-options-"+u),h.attr("role","listbox"),h.attr("tabindex","-1"),h.attr("aria-label","select options"),h.attr("aria-hidden","true"),h.css({width:a.width}),c.css({width:a.width,background:a.background}),r.css({width:a.width}),null!==a.height&&h.css({height:a.height,overflow:"auto"}),e.each(a.data,function(d,t){t.selected&&(a.defaultSelectedIndex=d);var i=e("<li role='option'>").addClass("dd-option").attr("id","dd-option-"+u+"-"+d);t.value&&i.append(e("<input>").addClass("dd-option-value").attr("type","hidden").val(t.value)),t.imageSrc&&i.append(e("<img>").attr("src",t.imageSrc).addClass("dd-option-image"+("right"===a.imagePosition?" dd-image-right":""))),t.text&&i.append(e("<label>").addClass("dd-option-text").text(t.text)),t.description&&i.append(e("<small>").addClass("dd-option-description dd-desc").text(t.description)),h.append(i)}),h.keydown(function(d){var i=e(this);if("false"==i.attr("aria-hidden")){var a="dd-option-selected",o=[],s=e("."+a,i);switch(d.key){case"ArrowLeft":case"ArrowUp":return s.length?s.is(":first-child")||(o=s.removeClass(a).prev().addClass(a),i.attr("aria-activedescendant",o.attr("id"))):((o=e(".dd-option:first-child")).addClass(a),i.attr("aria-activedescendant",o.attr("id"))),!1;case"ArrowRight":case"ArrowDown":return s.length?s.is(":last-child")||(o=s.removeClass(a).next().addClass(a),i.attr("aria-activedescendant",o.attr("id"))):((o=e(".dd-option:first-child")).addClass(a),i.attr("aria-activedescendant",o.attr("id"))),!1;case"Enter":case" ":return s.length&&t(r,s.index(),!0),n(r),g.focus(),!1;case"Escape":return n(r),g.focus(),!1}}});var m={settings:a,original:p,selectedIndex:-1,selectedItem:null,selectedData:null};if(r.data("ddslick",m),a.selectText.length>0&&null===a.defaultSelectedIndex)r.find(".dd-selected").html(a.selectText);else{var v=null!=a.defaultSelectedIndex&&a.defaultSelectedIndex>=0&&a.defaultSelectedIndex<a.data.length?a.defaultSelectedIndex:0;t(r,v,!1)}r.find(".dd-select").on("click.ddslick",function(){i(r)}),r.find(".dd-option").on("click.ddslick",function(){t(r,e(this).index(),!0)}),r.find(".dd-options").on("focusout.ddslick",function(){setTimeout(function(){0==r.find(".dd-options").has(document.activeElement).length&&n(r)},50)}),a.clickOffToClose&&(h.addClass("dd-click-off-close"),r.on("click.ddslick",function(e){e.stopPropagation()}),l||(l=!0,e("body").on("click",function(){e(".dd-open").removeClass("dd-open"),e(".dd-selected").attr("aria-expanded","false"),e(".dd-click-off-close").slideUp(a.animationTime).attr("aria-hidden","true").siblings(".dd-select").find(".dd-pointer").removeClass("dd-pointer-up")})))}})},a.select=function(i){return this.each(function(){void 0!==i.index&&t(e(this),i.index),void 0!==i.value&&d(e(this),i.value),void 0!==i.id&&d(e(this),i.id)})},a.open=function(){return this.each(function(){var d=e(this);d.data("ddslick")&&i(d)})},a.close=function(){return this.each(function(){var d=e(this);d.data("ddslick")&&n(d)})},a.destroy=function(){return this.each(function(){var d=e(this),t=d.data("ddslick");if(t){var i=t.original;d.removeData("ddslick").unbind(".ddslick").replaceWith(i)}})}});
...
"use strict";module.exports=function(){for(var l=$(".collapsible"),o=$(".collapsible-dropdown"),e=function(e){l[e].addEventListener("click",function(){$(this).next().slideToggle(),o[e].classList.toggle("collapsible-dropdown-close")})},s=0;s<l.length;s++)e(s)};

},{}],26:[function(require,module,exports){
"use strict";module.exports=function(){var n=$(".container-category a");n.hover(function(){$.each(n,function(n,c){$(c).css({margin:"0 7px"})})},function(){$.each(n,function(n,c){$(c).css({margin:"0 12.5px"}),0===n&&$(c).css({margin:"0 12.5px 0 0"}),3===n&&$(c).css({margin:"0 0 0 12.5px"})})})};

},{}],27:[function(require,module,exports){
"use strict";function init(){this.$=require("jquery/dist/jquery"),this.jQuery=this.$,require("svg4everybody/dist/svg4everybody")(),$(document).ready(function(){require("ddslick/dist/jquery.ddslick.min"),require("./components/collapse")(),require("./components/items-category")()})}require("core-js/modules/es6.function.bind"),init.bind(window)();

},{"./components/collapse":25,"./components/items-category":26,"core-js/modules/es6.function.bind":21,"ddslick/dist/jquery.ddslick.min":22,"jquery/dist/jquery":23,"svg4everybody/dist/svg4everybody":24}]},{},[27]);
