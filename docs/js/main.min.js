...
"use strict";module.exports=function(){var t=$(".nav-bar__switch-language span"),n=$(".switch-language__sub-menu");t.on("click",function(){n.toggle()}),n.on("click","li",function(){var a=$(this).data("short-name");n.toggle(),t.text(a)})};
